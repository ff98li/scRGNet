...
An example of a cell-cell network produced by this package using `plotCellNet()` follows:
![](./inst/extdata/batch_5_epoch_100_loss_21910_ltmg_k24.png){ width=75% }

The degree distribution of a network can be viewed through `plotDegree()`:

![](./inst/extdata/dist.png){ width=75% }
